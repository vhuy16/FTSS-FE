...
export default function ConfirmRefundedBooking({
    isModalOpenActivate,
                            ...
                            <div className="relative bg-white rounded-lg shadow-sm dark:bg-gray-700">
                                ...
                                <div className="p-4 md:p-5 text-center">
                                    ...
                                    <h3 className="mb-5 text-lg font-normal text-gray-500 dark:text-gray-400">
                                        Xác nhận đã hoàn tiền cho đơn bảo trì này?
                                    </h3>
                                    <button
                                        type="button"
                                    ...
                                    <button
                                        type="button"
                                        className="py-2.5 px-5 ms-3 text-sm font-medium text-gray-900 focus:outline-none bg-white rounded-lg bbooking bbooking-gray-200 hover:bg-gray-100 hover:text-blue-700 focus:z-10 focus:ring-4 focus:ring-gray-100 dark:focus:ring-gray-700 dark:bg-gray-800 dark:text-gray-400 dark:bbooking-gray-600 dark:hover:text-white dark:hover:bg-gray-700"
                                        onClick={() => {
                                            setIsModalOpenActivate(false);
                                        }}
                                    >
