...
import { activeVoucher, Voucher } from '@redux/slices/voucherSlice';
type ConfirmActivatevoucher = {
...
export default function ConfirmActivatevoucher({
    isModalOpenActivate,
    setIsModalOpenActivate,
    voucher,
}: ConfirmActivatevoucher) {
    const dispatch = useAppDispatch();
    const isLoading = useAppSelector((state) => state.voucher.isLoadingActive);
    return (
        <>
            {/* Modal */}
            <div>
                            ...
                            <div className="relative bg-white rounded-lg shadow-sm dark:bg-gray-700">
                                ...
                                <div className="p-4 md:p-5 text-center">
                                    ...
                                    <button
                                        ...
                                        onClick={async () => {
                                            await dispatch(activeVoucher(voucher.id));
                                            setIsModalOpenActivate(false);
                                        }}
                                    >
