...
import { activeCategory, categoryType } from '@redux/slices/categorySlice';
type ConfirmActivateCategory = {
...
export default function ConfirmActivateCategory({
    isModalOpenActivate,
    setIsModalOpenActivate,
    category,
}: ConfirmActivateCategory) {
    const dispatch = useAppDispatch();
    const isLoading = useAppSelector((state) => state.category.isLoadingActiveCategory);
    return (
        <>
            {/* Modal */}
            <div>
                            ...
                            <div className="relative bg-white rounded-lg shadow-sm dark:bg-gray-700">
                                ...
                                <div className="p-4 md:p-5 text-center">
                                    ...
                                    <button
                                        ...
                                        onClick={async () => {
                                            try {
                                                await dispatch(activeCategory(category.id)).unwrap();
                                                setIsModalOpenActivate(false);
                                            } catch (error) {
