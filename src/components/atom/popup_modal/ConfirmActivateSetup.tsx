...
export default function ConfirmActivateSetup({
    isModalOpenActivate,
    setIsModalOpenActivate,
    setup,
}: ConfirmActivateSetup) {
    const dispatch = useAppDispatch();
    const isLoading = useAppSelector((state) => state.setupPackage.isLoadingEnable);
    return (
        <>
            {/* Modal */}
            <div>
                            ...
                            <div className="relative bg-white rounded-lg shadow-sm dark:bg-gray-700">
                                ...
                                <div className="p-4 md:p-5 text-center">
                                    ...
                                    <h3 className="mb-5 text-lg font-normal text-gray-500 dark:text-gray-400">
                                        Bạn có muốn kích hoạt mẫu thiết kế này?
                                    </h3>
                                    <button
                                        type="button"
                                        ...
                                        onClick={async () => {
                                            await dispatch(activateSetup(setup.setupPackageId));
                                            setIsModalOpenActivate(false);
                                        }}
                                    >
