...
const CardDataStats: React.FC<CardDataStatsProps> = ({ title, total, rate, levelUp, levelDown, children }) => {
  return (
    <div className="rounded-sm border border-stroke bg-white py-5 pr-10 shadow-default dark:border-strokedark dark:bg-boxdark">
      <div className="flex h-12 w-12 items-center justify-center rounded-full bg-meta-2 dark:bg-meta-4 ml-6">
        {children}
      </div>
      <div className="mt-4 ml-6 flex items-end justify-between">
        ...
        <span
          className={`flex items-center  text-sm font-medium ${levelUp && "text-meta-3"} ${
