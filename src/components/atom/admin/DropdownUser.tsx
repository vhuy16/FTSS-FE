...
// import UserOne from '@images/coc.jpg';
        ...
        <ClickOutside onClick={() => setDropdownOpen(false)} className="relative">
            ...
            >
                <span className="hidden text-right lg:block">
                    ...
                    <span className="block text-xs text-gray-500 dark:text-gray-400">Admin Of Souvi</span>
                </span>

                <span className="h-12 w-12 rounded-full overflow-hidden">
                    {/* <img src={UserOne} alt="User" className="w-full h-full object-cover" /> */}
                </span>
